...
public class PortalGate_Controller : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            if (!PortalUp) other.transform.position = new Vector3(18.824f, 4.883f, -11f);
            else other.transform.position = new Vector3(18.824f, 0.3f, -11f);
