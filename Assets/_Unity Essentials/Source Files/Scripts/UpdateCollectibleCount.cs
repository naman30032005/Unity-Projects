...
public class UpdateCollectibleCount : MonoBehaviour
{
    ...
    private bool celebratePlayed = false;
    ...
    private void UpdateCollectibleDisplay()
    {
        ...
        if (totalCollectibles == 0 && !celebratePlayed)
        {
        ...
        if (celebratePlayed) collectibleText.text = $"You have collected everything";
        // Update the collectible count display
        else collectibleText.text = $"Collectibles remaining: {totalCollectibles}";
